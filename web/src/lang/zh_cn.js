export default {
  ...
  ai: {
    ...
    aiCreatePart: 'AI续写',
    // 新增配置相关
    AIConfigSubtitle: '选择 AI 模型的使用方式',
    currentMode: '当前模式',
    localCustomMode: '本地/自定义模式',
    serverMode: '服务器配置',
    serverConfigWithPwd: '服务器配置（访问密码）',
    localConfig: '本地配置',
    accessPassword: '访问密码',
    localConfigDesc: '使用您自己的 API Key 连接 OpenAI、Ollama 或其他兼容服务。配置保存在本地浏览器中。',
    manageLocalConfig: '管理本地模型配置',
    serverConfigDesc: '请输入访问密码以使用服务器端配置的 AI 模型。',
    enterPasswordPlaceholder: '请输入访问密码',
    verify: '验证',
    saveAndApply: '保存并生效',
    verifySuccess: '验证成功',
    verifyFailed: '验证失败',
    pleaseVerifyPasswordFirst: '请先验证访问密码',
    localConfigManager: '本地配置管理',
    manageTip: '管理您的 API 连接与模型参数',
    passwordModeTip: '提示：若启用"访问密码"模式，将优先使用服务器端配置。',
    newConfig: '新建配置',
    noConfigTip: '暂无配置，请新建',
    currentUsing: '当前使用',
    testConfig: '测试配置',
    edit: '编辑',
    copy: '复制',
    ...
    deleteSuccess: '删除成功',
    testingConfig: '正在测试配置...',
    connectTestDone: '连接测试完成，请检查配置是否正确',
    connectPossible: '配置可用',
    editConfig: '编辑配置',
    configName: '配置名称',
    configNamePlaceholder: '给配置起个名字',
    requestType: '请求类型',
    apiAddress: 'API 地址',
    apiAddressPlaceholder: '请输入 API 地址',
    apiTip: 'API 地址示例：https://api.openai.com/v1/chat/completions',
    apiKey: 'API Key',
    apiKeyPlaceholder: '请输入 API Key',
    modelName: '模型名称',
    modelNamePlaceholder: '请输入模型名称，如 gpt-3.5-turbo',
    save: '保存',
    required: '此项必填',
